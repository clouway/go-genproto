...
// UnprocessableEntityError is an error used to indicate unprocessable entity
// errors.
type UnprocessableEntityError struct {
	...
	Message string `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`
	// Describes all violation errors in a client request.
	Errors []*UnprocessableEntityError_FieldViolation `protobuf:"bytes,2,rep,name=errors,proto3" json:"errors,omitempty"`
	// A error code for non-field-specific errors.
	Code string `protobuf:"bytes,3,opt,name=code,proto3" json:"code,omitempty"`
	// Additional details about the global error.
	Details []string `protobuf:"bytes,4,rep,name=details,proto3" json:"details,omitempty"`
...
func (x *UnprocessableEntityError) Reset() {
	*x = UnprocessableEntityError{}
	if protoimpl.UnsafeEnabled {
...
func (x *UnprocessableEntityError) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UnprocessableEntityError) ProtoMessage() {}

func (x *UnprocessableEntityError) ProtoReflect() protoreflect.Message {
	mi := &file_clouway_rpc_errdetails_error_details_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UnprocessableEntityError.ProtoReflect.Descriptor instead.
func (*UnprocessableEntityError) Descriptor() ([]byte, []int) {
	return file_clouway_rpc_errdetails_error_details_proto_rawDescGZIP(), []int{2}
}

func (x *UnprocessableEntityError) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *UnprocessableEntityError) GetErrors() []*UnprocessableEntityError_FieldViolation {
	if x != nil {
		return x.Errors
	}
	return nil
...
func (x *UnprocessableEntityError) GetCode() string {
	if x != nil {
		return x.Code
	}
	return ""
...
func (x *UnprocessableEntityError) GetDetails() []string {
	if x != nil {
		return x.Details
	}
	return nil
...
func (*ErrorInfo) Descriptor() ([]byte, []int) {
	return file_clouway_rpc_errdetails_error_details_proto_rawDescGZIP(), []int{3}
}
...
func (x *BadRequest_FieldViolation) Reset() {
	*x = BadRequest_FieldViolation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_clouway_rpc_errdetails_error_details_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
// A message type used to describe a single request field.
type UnprocessableEntityError_FieldViolation struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *UnprocessableEntityError_FieldViolation) Reset() {
	*x = UnprocessableEntityError_FieldViolation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_clouway_rpc_errdetails_error_details_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *UnprocessableEntityError_FieldViolation) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UnprocessableEntityError_FieldViolation) ProtoMessage() {}

func (x *UnprocessableEntityError_FieldViolation) ProtoReflect() protoreflect.Message {
	mi := &file_clouway_rpc_errdetails_error_details_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UnprocessableEntityError_FieldViolation.ProtoReflect.Descriptor instead.
func (*UnprocessableEntityError_FieldViolation) Descriptor() ([]byte, []int) {
	return file_clouway_rpc_errdetails_error_details_proto_rawDescGZIP(), []int{2, 0}
}

func (x *UnprocessableEntityError_FieldViolation) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
func (x *UnprocessableEntityError_FieldViolation) GetField() string {
	if x != nil {
		return x.Field
	}
	return ""
...
func (x *UnprocessableEntityError_FieldViolation) GetCode() string {
	if x != nil {
		return x.Code
	}
	return ""
...
func (x *UnprocessableEntityError_FieldViolation) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_clouway_rpc_errdetails_error_details_proto_rawDesc = []byte{
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x92, 0x02, 0x0a, 0x18, 0x55, 0x6e, 0x70,
	...
	0x28, 0x2e, 0x55, 0x6e, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x45,
	0x6e, 0x74, 0x69, 0x74, 0x79, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x2e, 0x46, 0x69, 0x65, 0x6c, 0x64,
	0x56, 0x69, 0x6f, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x06, 0x65, 0x72, 0x72, 0x6f, 0x72,
	...
	0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x1a,
	0x6c, 0x0a, 0x0e, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x56, 0x69, 0x6f, 0x6c, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x66, 0x69, 0x65,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x12, 0x34, 0x0a, 0x08, 0x6d,
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e,
	...
	,
...
var file_clouway_rpc_errdetails_error_details_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_clouway_rpc_errdetails_error_details_proto_goTypes = []interface{}{
	...
	(*UnprocessableEntityError)(nil),                // 2: UnprocessableEntityError
	(*ErrorInfo)(nil),                               // 3: ErrorInfo
	(*QuotaFailure_Violation)(nil),                  // 4: QuotaFailure.Violation
	(*BadRequest_FieldViolation)(nil),               // 5: BadRequest.FieldViolation
	(*UnprocessableEntityError_FieldViolation)(nil), // 6: UnprocessableEntityError.FieldViolation
	nil, // 7: ErrorInfo.MetadataEntry
}
var file_clouway_rpc_errdetails_error_details_proto_depIdxs = []int32{
	4, // 0: QuotaFailure.violations:type_name -> QuotaFailure.Violation
	5, // 1: BadRequest.errors:type_name -> BadRequest.FieldViolation
	6, // 2: UnprocessableEntityError.errors:type_name -> UnprocessableEntityError.FieldViolation
	7, // 3: ErrorInfo.metadata:type_name -> ErrorInfo.MetadataEntry
...
func file_clouway_rpc_errdetails_error_details_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_clouway_rpc_errdetails_error_details_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UnprocessableEntityError); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_clouway_rpc_errdetails_error_details_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_clouway_rpc_errdetails_error_details_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UnprocessableEntityError_FieldViolation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
